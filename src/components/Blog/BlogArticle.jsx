const cards = [
  {
    ...
    descripcion: [
      ...
      {
        parrafo5:
          "<u>Sintéticas o de cerámica:</u> Son creadas a partir de fibra de vidrio, cuenta con material sintético llamado aramida. Ventaja: son más ligeras, resistentes y con una gran capacidad para transmitir el calor, son las más eficientes del mercado. Desventaja: el precio puede ser elevado para algunos usuarios.Sintéticas o de cerámica: Son creadas a partir de fibra de vidrio, cuenta con material sintético llamado aramida. Ventaja: son más ligeras, resistentes y con una gran capacidad para transmitir el calor, son las más eficientes del mercado. Desventaja: el precio puede ser elevado para algunos usuarios.",
      },
    ],
  },
  {
        ...
        <div className="mb-4 md:mb-0 w-full mx-auto relative">
          <div className="px-4 lg:px-0">
            <h2 className="text-4xl font-semibold text-gray-800 leading-tight mb-4">
              Tipos de balatas sus ventajas y desventajas.
            </h2>
          </div>
          <img
